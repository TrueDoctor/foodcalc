...
CREATE TABLE public.metro_categories (
    ingredient_source_id integer NOT NULL,
    category character varying NOT NULL,
    PRIMARY KEY (ingredient_source_id),
    CONSTRAINT ingredient_source_fk FOREIGN KEY (ingredient_source_id) REFERENCES public.ingredient_sources(ingredient_source_id)
);
